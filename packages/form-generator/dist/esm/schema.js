import { z } from 'zod';
var FormInputSchemaEnum = z["enum"]([
    'mobileNumber',
    'phoneNumber',
    'email',
    'text',
...
export var FormInputEnum = FormInputSchemaEnum["enum"];
export var numberOrComplex = z.union([
    z.number(),
    z.object({
        value: z.number(),
        message: z.string()
...
var booleanOrString = z.union([z.boolean(), z.string()]);
var validateOption = z.union([
    z["function"](z.tuple([z.string()]), z.union([z.boolean(), z.string()])),
    z.record(z["function"](z.tuple([z.string()]), z.union([z.boolean(), z.string()]))),
]);
var ValidationRules = z.object({
...
var ShareDataSchema = z.object({
    title: z.string().optional(),
    url: z.string().optional(),
    text: z.string().optional(),
    image: z.string().optional()
});
export var DisplayConditionSchema = z
    .object({
    questionId: z.string(),
    operator: z.string(),
    ...
    .optional();
export var FormInputSchema = z.object({
    name: z.string(),
