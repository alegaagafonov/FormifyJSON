import { FormField, FormInputTypes } from './interfaces';
export const formInputs: FormField[] = [
  ...
  {
    name: 'detailedFeedback', //SatisfactorySurveyKeys.detailedFeedback,
    label: 'What could we do better?',
    type: FormInputTypes.MultimediaSuggestion,
    placeholder:
      'Please let us know what aspects of our product or service disappointed you and how we can improve.',
    displayCondition: {
  ...
  },
  {
    ...
    type: FormInputTypes.MultimediaSuggestion,
    placeholder:
      'What aspects of our product or service can be improved to meet your expectations better?',
    displayCondition: {
      questionId: 'overallGrade',
      operator: 'eq',
      value: 3
  ...
  },
  {
    ...
    type: FormInputTypes.MultimediaSuggestion,
    placeholder:
      "We're glad you're satisfied! Please share any suggestions for further improvements or features you'd like to see.",
    displayCondition: {
      questionId: 'overallGrade',
      operator: 'gte',
      value: 4
